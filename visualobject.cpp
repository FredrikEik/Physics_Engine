...
float VisualObject::barycentricHeight(const gsml::Vector3d &point, const gsml::Vector3d &corner1, const gsml::Vector3d &corner2, const gsml::Vector3d &corner3)
    {
        ...
        gsml::GLfloat d00 = (v0.x * v0.x +  v0.y * v0.y);
        gsml::GLfloat d01 = (v0.x * v1.x +  v0.y * v1.y);
        gsml::GLfloat d11 = (v1.x * v1.x +  v1.y * v1.y);
        gsml::GLfloat d20 = (v2.x * v0.x +  v2.y * v0.y);
        gsml::GLfloat d21 = (v2.x * v1.x +  v2.y * v1.y);
        gsml::GLfloat invDenom = 1.0f / (d00 * d11 - d01 * d01);

        // u, v, w are the barycentric coordinates
        gsml::GLfloat v = (d11 * d20 - d01 * d21) * invDenom;
        gsml::GLfloat w = (d00 * d21 - d01 * d20) * invDenom;
        gsml::GLfloat u = 1.0f - v - w;

//        qDebug() << "BaryCords:" << u << v << w;

        gsml::GLfloat heightOut;
